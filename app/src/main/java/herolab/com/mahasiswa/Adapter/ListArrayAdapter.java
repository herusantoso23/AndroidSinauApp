package herolab.com.mahasiswa.Adapter;
...
import herolab.com.mahasiswa.R;
...
public class ListArrayAdapter extends ArrayAdapter<ModelData> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        holder.ID.setText(list.get(position).getUsername());
        holder.Nama.setText(list.get(position).getNama());
        holder.Jenis.setText(list.get(position).getTtl());
